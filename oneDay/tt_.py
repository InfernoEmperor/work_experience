...
def push_sql(content):
    ...
    try:
        ...
        logging.error('function push_sql insert error!')
    finally:
        sqlserver.Close()

if __name__ == '__main__':
    url_lst = ['http://www.kejilie.com/leiphone/article/fm2ABr.html','http://www.kejilie.com/leiphone/article/fm2ABr.html','http://www.kejilie.com/pedaily/article/673mqy.html']
